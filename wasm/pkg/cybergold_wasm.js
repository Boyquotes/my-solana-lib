 ...
 * @returns {bigint}
 */
export function compute_collat_per_synth_price_mantissa(ref_price_price, ref_price_conf, ref_price_exponent, collat_price_price, collat_price_conf, collat_price_exponent, stake_pool_total_lamports, stake_pool_pool_token_supply, pool_params_price_factor_signif, pool_params_price_factor_exp, collat_mint_decimals, synth_mint_decimals) {
 ...
 * @returns {bigint}
 */
export function compute_pool_ur(computed_pool_backing_capacity, computed_pool_liabilities) {
 ...
 * @returns {bigint}
 */
export function compute_pnl_accum(pool_state_total_realized_equity, pool_state_shares, computed_pool_equity) {
 ...
 * @returns {bigint}
 */
export function compute_updated_pool_max_exposure(pool_state_shares, pool_state_max_exposure_pct_fp9, delta_shares, vault_max_exposure_pct) {
 ...
 * @returns {bigint}
 */
export function compute_synth_to_collat_amount(synth_amount, collat_per_synth_price, exponent) {
 ...
 * @returns {bigint}
 */
export function compute_bound_price_mantissa(price, conf, is_upper) {
 ...
 * @returns {bigint}
 */
export function compute_staking_rewards(pool_state_lst_supply, pool_state_stake_pool_lamports, pool_collat_ata_amount, stake_pool_total_lamports, stake_pool_pool_token_supply) {
 ...
 * @returns {bigint}
 */
export function compute_pool_mintable_synth(pool_state_supply, computed_pool_backable_synth) {
 ...
 * @returns {bigint}
 */
export function compute_pool_backable_synth(computed_pool_backing_capacity, computed_price_price, computed_price_conf, computed_price_exponent) {
 ...
 * @returns {bigint}
 */
export function compute_pool_backing_capacity(computed_pool_equity, pool_state_max_exposure_pct_fp9) {
 ...
 * @returns {bigint}
 */
export function compute_vault_withdrawable_collat(computed_pool_excess_collat, computed_vault_equity) {
 ...
 * @returns {bigint}
 */
export function compute_pool_free_collat(pool_collat_ata_amount, pool_state_max_exposure_pct_fp9, computed_pool_liabilities) {
 ...
 * @returns {bigint}
 */
export function compute_vault_cr(vault_shares, pool_state_shares, computed_pool_liabilities, computed_vault_equity) {
 ...
 * @returns {bigint}
 */
export function compute_vault_equity(vault_entry_equity, computed_vault_pnl) {
 ...
 * @returns {bigint}
 */
export function compute_vault_pnl(vault_shares, vault_entry_pnl_accum, computed_current_pnl_accum) {
 ...
 * @returns {bigint}
 */
export function compute_current_pnl_accum(pool_state_shares, pool_state_total_realized_equity, computed_pool_equity) {
 ...
 * @returns {bigint}
 */
export function compute_pool_equity(pool_collat_ata_amount, computed_pool_liabilities) {
 ...
 * @returns {bigint}
 */
export function compute_pool_liabilities(pool_state_supply, computed_price_price, computed_price_conf, computed_price_exponent) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cybergold_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
